...
.calculator .calculator-border .calculator-display{
  ...
  -webkit-box-shadow: 1rem 1rem 0.5rem #1a886c;
  box-shadow: 0.1rem 0.1rem 0.5rem #1a886c; /*ganti shadow warna display*/
}
...
.calculator .calculator-border .calculator-items .calculator-item{
  border: 0.1rem solid rgba(24, 121, 84, 0.74);
  width: 16.666%;
  height: 4rem;
  ...
  background-color: rgba(255, 255, 255, 0.78);/*ganti warna keyboard*/
  -webkit-box-shadow: 0.1rem 0.1rem 0.3rem rgb(35, 161, 113);/*ganti shadow keyboard*/
  box-shadow: 0.1rem 0.1rem 0.3rem rgb(35, 161, 113);
  transition: all 0.1s;
...
.calculator .calculator-border .calculator-items .calculator-item:hover{
  color: #118663;
  -webkit-box-shadow: 0.3rem 0.3rem 0.5rem #208365;
  box-shadow: 0.3rem 0.3rem 0.5rem #208365;

}
/*ganti warna border calculator*/
